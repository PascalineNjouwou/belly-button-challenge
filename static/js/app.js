// 1. Use the D3 library to read in samples.json from the specified URL.
// Set the URL to a variable
const url = "https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json";

// 2. Create a horizontal bar chart with a dropdown menu to display the top 10 OTUs found in that individual

// Create empty objects to store JSON values
let data = {};
...
function updateBarChart(otu_ids, sample_values, otu_labels) {
    let barLabels = otu_ids.slice(0, 10).map(id => `OTU ${id}`);
    let trace1 = {
